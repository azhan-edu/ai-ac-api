...
from lib_messaging import add_user_message, add_assistant_message, chat, text_from_message, client, model
...
add_user_message(messages, "What is the current date and time?  Also want is the current time in SS format?")

# print("Initial messages:", messages)
response =  run_conversation(messages)
# print("Final messages:", response)    
